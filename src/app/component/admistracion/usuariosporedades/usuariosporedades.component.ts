...
@Component({
  selector: 'app-usuariosporedades',
  templateUrl: './usuariosporedades.component.html',
  styleUrls: ['./usuariosporedades.component.css'],
  providers: [
...
export class UsuariosporedadesComponent implements OnInit {
