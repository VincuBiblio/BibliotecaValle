...
@Component({
  selector: 'app-usuariosporgeneros',
  templateUrl: './usuariosporgeneros.component.html',
  styleUrls: ['./usuariosporgeneros.component.css'],
  providers: [
...
export class UsuariosporgenerosComponent implements OnInit {
  ...
  ejemplo(): Usuariosporedades {
    let ejemplos: Usuariosporgeneros = new Usuariosporgeneros();
    let datos: Datos;
    ...
    datos.num = 87;
    datos.pct = 34.64;
    ejemplos.masculino = datos;

    datos = new Datos();
    datos.num = 162;
    datos.pct = 65.06;
    ejemplos.femenino = datos;

    datos = new Datos();
    datos.num = 0;
    datos.pct = 0.00;
    ejemplos.otros = datos;

    return ejemplos;
  }

  graficar(ejemplo: Usuariosporgeneros) {
    // Create the chart
    // @ts-ignore
    Highcharts.chart('container', {
      ...
      series: [{
        ...
        data: [{
          name: "MASCULINO",
          y: ejemplo.masculino?.num,
        },
          {
            name: "FEMENINO",
            y: ejemplo.femenino?.num,
          },
          {
            name: "OTRO",
            y: ejemplo.otros?.num,
